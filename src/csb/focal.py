"""Experimental focal-mode filters for CDL preprocessing.

These filters approximate the Google Earth Engine preprocessing described by
Hunt et al. (2024). Validation sweeps found that they reduced agreement with
USDA field boundaries, so the production CLI does not expose them and the
polygonize defaults leave them disabled.
"""
