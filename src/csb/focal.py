...
nonzero value in their neighborhood, iterated until stable. Superseded by the
USDA production noise filter (:mod:`csb.usda_filter`, ``--usda-noise-filter``);
kept as a documented baseline. Enable with ``--focal-radius 1``.
